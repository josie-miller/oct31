...
# Combined model for predictions
...
st.write("This app visualizes population growth in the United States using exponential and logistic models for three historical periods.")
